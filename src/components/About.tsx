  ...
  const capabilityZones = [
    {
      ...
      skills: ['Advanced Power BI', 'Advanced SQL', 'DAX', 'Power Query', 'Excel', 'Star Schema', 'Snowflake Schema'],
      color: '#FF6B00',
    },
    {
      ...
      skills: ['Python', 'dbt', 'DataBricks', 'Snowflake', 'Cloud Azure stack ', 'Microsoft stack(SSMS,SSIS,TSQL...)', 'Microsoft Fabric ', 'Data Governance', 'Apache Spark', 'CI/CD', 'Airflow', 'PostgreSQL', 'Apache Kafka', 'Hadoop'],
      color: '#00D9FF',
    },
    {
      ...
      skills: ['RAG System', 'NLP', 'Computer Vision', 'LangChain', 'CrewAI', 'OpenCV'],
      color: '#2EC4B6',
    },
    {
